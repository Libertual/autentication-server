module.exports = {
  // App Settings
  MONGO_URI: process.env.MONGO_URI || 'localhost/Auth',
  TOKEN_SECRET: process.env.TOKEN_SECRET || 'TokenSuperSecreto',
  ...
  // OAuth 1.0
  TWITTER_KEY: process.env.TWITTER_KEY || 'oupdjGqoN4hQ1cz2mf0iFkhdU',
  TWITTER_SECRET: process.env.TWITTER_SECRET || 'HPVTq3tWm7Xhub2hU2IpNImQBl439U8uFNBoBmqcBry71QyeUW'
};
